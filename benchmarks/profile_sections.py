...
SECTIONS = {
    ...
    "sdpa.mma": [
        "Setup",
        "Read Q from memory",
        "Convert Q to half precision",
        "Read K from memory",
        "Convert K to half precision",
        "Stage Q and K for tensor core multiply",
        "Multiply Q by K-transposed (tensor core)",
        "Save attention scores",
        "Softmax part 1: find row max",
        "Softmax part 2: compute exp and sum",
        "Softmax part 3: normalize",
        "Read V from memory",
        "Convert V to half precision",
        "Stage attention and V for tensor core multiply",
        "Multiply attention by V (tensor core)",
        "Write output to memory",
    ],
